...
class CTABGAN():
    ...
    3) generate_samples() -> returns a generated and post-processed synthetic dataframe with the same size and format as per the input data 
    """
    ...
    def fit(self):
        ...
        # The following line appears to be unused. If it is not needed, consider removing it.
    ...
    def generate_samples(self):
        ...
        return sample_df  # debug: check synthetic sample generation
